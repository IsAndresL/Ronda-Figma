...
import { tables, mockOrders, mockPayments, formatCOP, Order, Payment, getInitials, getDinersByTable } from '../../models/data/mockData';
import { useWaiterAuth } from '../../models/context/WaiterAuthContext';
